...
static void parse_arguments(int argc, char *argv[], char **port, char **backlog);
static void handle_arguments(const char *binary_name, const char *port_str, const char *backlog_str, in_port_t *port, int *backlog);
...
int main(int argc, char *argv[])
{
    ...
    port_str = NULL;
    backlog_str = NULL;
    parse_arguments(argc, argv, &port_str, &backlog_str);
    handle_arguments(argv[0], port_str, backlog_str, &port, &backlog);
