...
static void           child_process(const int pipefd[2], FILE *file, sem_t *sem_parent, sem_t *sem_child);
static void           parent_process(const int pipefd[2], sem_t *sem_parent, sem_t *sem_child);
